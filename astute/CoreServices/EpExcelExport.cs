...
namespace astute.CoreServices
{
    public class EpExcelExport
    {
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        for (int j = 0; j < column_dt.Rows.Count; j++)
                        {
                            ...
                            else
                            {
                                ...
                                else if (Column_Name == "QC Dept Remarks")
                                {
                                    worksheet.Cells[inwrkrow, kk].Value = Convert.ToString(dtStock.Rows[i - inStartIndex][Column_Name]);
                                }
                            }
        ...
        public static void Create_Lab_Entry_Report_Pickup_Excel(DataTable dtStock, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
        ...
        public static void Create_Purchase_Pricing_Excel(DataTable pricing_dt, DataTable pricing_column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
                {
                    ...
                    Dictionary<string, int> columnPixelWidths = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        ["Culet"] = 55,
                        ["Comments"] = 70,
                        ["Supplier Final Disc(%)"] = 54,
                        ["Supplier Final Value"] = 70,
                        ["Shade"] = 55,
                        ["Table Inclusion"] = 49,
                        ["Crown Inclusion"] = 44,
                        ["Table Natts"] = 44,
                    ...
                    for (int j = 0; j < pricing_column_dt.Rows.Count; j++)
                    {
                        string columnName = Convert.ToString(pricing_column_dt.Rows[j]["Column_Name"]);
                        k++;

                        worksheet.Cells[2, k].Value = columnName;

                        int pixelWidth = columnPixelWidths.TryGetValue(columnName, out int value) ? value : 0;
                        double excelWidth = GetExcelWidth(pixelWidth);
                    ...
                    for (pi = pinStartIndex; pi < pinEndCounter; pi++)
                    {
                        ...
                        for (int j = 0; j < pricing_column_dt.Rows.Count; j++)
                        {
                            string Column_Name = Convert.ToString(pricing_column_dt.Rows[j]["Column_Name"]);
                            {
                                ...
                                if (Column_Name == "Lab")
                                {
                                    string labValue = Convert.ToString(pricing_dt.Rows[pi - pinStartIndex][Column_Name]);
                                    string certificateURL = Convert.ToString(pricing_dt.Rows[pi - pinStartIndex]["CERTI"]);
                                ...
                                {
                                    string Image_URL = Convert.ToString(pricing_dt.Rows[pi - pinStartIndex][Column_Name]);
                                ...
                                {
                                    string Video_URL = Convert.ToString(pricing_dt.Rows[pi - pinStartIndex][Column_Name]);
                                ...
                                else if (Column_Name == "KTS Grade" || Column_Name == "Com" || Column_Name == "Zone" || Column_Name == "Sub Zone" || Column_Name == "P.Grade" || Column_Name == "Sunrise Grade" || Column_Name == "Sunrise Grading Comments")
                                {
                                    worksheet.Cells[pinwrkrow, pkk].Value = Convert.ToString(pricing_dt.Rows[pi - pinStartIndex][Column_Name]);
        ...
        public static void Create_Purchase_Detail_QC_Excel(DataTable dt, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
                {
                    ...
                    Color lightGreen = ColorTranslator.FromHtml("#C6E0B4");
                    ...
                    var pcellBackgroundColor1 = worksheet.Cells[2, 1, 2, Row_Count].Style.Fill;
                    pcellBackgroundColor1.PatternType = ExcelFillStyle.Solid;
                    pcellBackgroundColor1.BackgroundColor.SetColor(colFromHex);

                    ExcelStyle pcellStyleHeader1 = worksheet.Cells[2, 1, 2, Row_Count].Style;
                    pcellStyleHeader1.Border.Left.Style = pcellStyleHeader1.Border.Right.Style
                            = pcellStyleHeader1.Border.Top.Style = pcellStyleHeader1.Border.Bottom.Style
                            = ExcelBorderStyle.Medium;
                    #endregion
                        ...
                        for (int j = 0; j < column_dt.Rows.Count; j++)
                        {
                            string Column_Name = Convert.ToString(column_dt.Rows[j]["Column_Name"]);
                            {
                                ...
                                if (Column_Name == "Lab")
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(certificateURL) && !string.IsNullOrEmpty(labValue))
                                    {
                                        worksheet.Cells[inwrkrow, pkk].Value = labValue;
                                        worksheet.Cells[inwrkrow, pkk].Formula = "=HYPERLINK(\"" + certificateURL + "\",\"" + labValue + "\")";
                                        worksheet.Cells[inwrkrow, pkk].Style.Font.UnderLine = true;
                                        worksheet.Cells[inwrkrow, pkk].Style.Font.Color.SetColor(Color.Blue);
                                    }
                                }
                                else if (Column_Name == "Cts")
                                {
        ...
        public static void Create_Purchase_Detail_QC_Approval_Column_Wise_Excel(DataTable dtStock, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                DataTable s_dt = new DataTable();
                ...
                using (ExcelPackage ep = new ExcelPackage())
                {
                    ...
                    #region Company Detail on Header
                    ep.Workbook.Worksheets.Add("QC Approval");
                    ...
                    Dictionary<string, int> columnPixelWidths = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        ["Rap Rate"] = 64,
                        ["Rap Amount"] = 64,
                        ["Supplier Cost Disc(%)"] = 64,
                        ["Supplier Cost Value($)"] = 64,
                        ["Final Disc(%)"] = 64,
                        ["Final Amt US($)"] = 64,
                        ["Profit(%)"] = 64,
                        ["Profit"] = 64,
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        for (int j = 0; j < column_dt.Rows.Count; j++)
                        {
                            ...
                            else
                            {
                                if (Column_Name == "Lab")
                                {
                                    string Lab_Value = Convert.ToString(s_dt.Rows[i - inStartIndex]["LAB"]);
                                    worksheet.Cells[inwrkrow, kk].Value = Lab_Value;
                                    string Certificate_URL = Convert.ToString(s_dt.Rows[i - inStartIndex]["CERTIFICATE LINK"]);

                                    if (!string.IsNullOrEmpty(Certificate_URL) && !string.IsNullOrEmpty(Lab_Value))
                                    {
                                        worksheet.Cells[inwrkrow, kk].Formula = "=HYPERLINK(\"" + Convert.ToString(Certificate_URL) + "\",\" " + Convert.ToString(dtStock.Rows[i - inStartIndex]["LAB"]) + " \")";
                                        worksheet.Cells[inwrkrow, kk].Style.Font.UnderLine = true;
                                        worksheet.Cells[inwrkrow, kk].Style.Font.Color.SetColor(Color.Blue);
                                ...
                                else if (Column_Name == "Cts" || Column_Name == "Rap Rate" || Column_Name == "Rap Amount")
                                {
                                    string pav_Height = Convert.ToString(s_dt.Rows[i - inStartIndex][Column_Name]);
                                    worksheet.Cells[inwrkrow, kk].Value = !string.IsNullOrEmpty(pav_Height) ? Convert.ToDouble(s_dt.Rows[i - inStartIndex][Column_Name]) : 0;
                                    worksheet.Cells[inwrkrow, kk].Style.Numberformat.Format = "#,##0.00";
                                }
                                else if (Column_Name == "Supplier Cost Disc(%)" || Column_Name == "Supplier Cost Value($)")
                                {
                                    string pav_Height = Convert.ToString(s_dt.Rows[i - inStartIndex][Column_Name]);
                                    worksheet.Cells[inwrkrow, kk].Value = !string.IsNullOrEmpty(pav_Height) ? Convert.ToDouble(s_dt.Rows[i - inStartIndex][Column_Name]) : 0;
                                    worksheet.Cells[inwrkrow, kk].Style.Numberformat.Format = "#,##0.00";
                                ...
                                else if (Column_Name == "Final Disc(%)" || Column_Name == "Final Amt US($)")
                                {
                                    string pav_Height = Convert.ToString(s_dt.Rows[i - inStartIndex][Column_Name]);
                                    worksheet.Cells[inwrkrow, kk].Value = !string.IsNullOrEmpty(pav_Height) ? Convert.ToDouble(s_dt.Rows[i - inStartIndex][Column_Name]) : 0;
                                    worksheet.Cells[inwrkrow, kk].Style.Numberformat.Format = "#,##0.00";
                                ...
                                else if (Column_Name == "Profit(%)" || Column_Name == "Profit")
                                {
                                    string pav_Height = Convert.ToString(s_dt.Rows[i - inStartIndex][Column_Name]);
                                    worksheet.Cells[inwrkrow, kk].Value = !string.IsNullOrEmpty(pav_Height) ? Convert.ToDouble(s_dt.Rows[i - inStartIndex][Column_Name]) : 0;
                                    worksheet.Cells[inwrkrow, kk].Style.Numberformat.Format = "#,##0.00";
                    ...
                    for (int j = 0; j < column_dt.Rows.Count; j++)
                    {
                        ...
                        {
                            int finalColumnIndex = GetColumnIndexByName(worksheet, "Supplier Cost Value($)");
                            int rapColumnIndex = GetColumnIndexByName(worksheet, "Rap Amount");
                        ...
                        {
                            int finalColumnIndex = GetColumnIndexByName(worksheet, "Final Amt US($)");
                            int rapColumnIndex = GetColumnIndexByName(worksheet, "Rap Amount");
        ...
        public static void Create_Purchase_Detail_QC_Approval_Excel(DataTable dtStock, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
                {
                    ...
                    Color colFromHexTotal = ColorTranslator.FromHtml("#d9e1f2");
                    Color gold = ColorTranslator.FromHtml("#FFF2CC");
                    Color cyan = ColorTranslator.FromHtml("#CCFFFF");

                    #region Company Detail on Header
                    ep.Workbook.Worksheets.Add("Purchase QC");
                    ...
                    for (i = inStartIndex; i < inEndCounter; i++)
                    {
                        ...
                        for (int j = 0; j < column_dt.Rows.Count; j++)
                        {
                            ...
                            else
                            {
                                ...
                                else if (Column_Name == "Cert No" || Column_Name == "Shape" || Column_Name == "Pointer" || Column_Name == "BGM" || Column_Name == "Color" || Column_Name == "Clarity" || Column_Name == "Key To Symbol" || Column_Name == "Comment" || Column_Name == "Table White" || Column_Name == "Crown White" || Column_Name == "Table Black" || Column_Name == "Crown Black" || Column_Name == "Culet" || Column_Name == "Table Open" || Column_Name == "Crown Open" || Column_Name == "Pavilion Open" || Column_Name == "Girdle Open" || Column_Name == "Fls")
                                {
                                    worksheet.Cells[inwrkrow, kk].Value = Convert.ToString(dtStock.Rows[i - inStartIndex][Column_Name]);
                                }
                                else if (Column_Name == "Cts" || Column_Name == "Rap Rate" || Column_Name == "Rap Amount")
                                ...
                                else if (Column_Name == "Final Disc%" || Column_Name == "Final Amount")
                                {
                                    string pav_Height = Convert.ToString(dtStock.Rows[i - inStartIndex][Column_Name]);
                                    worksheet.Cells[inwrkrow, kk].Value = !string.IsNullOrEmpty(pav_Height) ? Convert.ToDouble(dtStock.Rows[i - inStartIndex][Column_Name]) : 0;
                                    worksheet.Cells[inwrkrow, kk].Style.Numberformat.Format = "#,##0.00";
        ...
        private static double GetExcelWidth(int pixels)
        {
            if (pixels <= 0) return 0;
            return Math.Round((pixels - 5.0) / 7.0 + 0.71, 2);
        }
        ...
        public static void Create_Purchase_Detail_With_Pending_Upcoming_QC_Pricing_Excel(DataTable dt, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
        ...
        public static void Create_Purchase_Detail_With_Pending_Upcoming_Excel(DataTable dt, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
                        ...
                        for (int j = 0; j < column_dt.Rows.Count; j++)
                        {
                            string Column_Name = Convert.ToString(column_dt.Rows[j]["Column_Name"]);
                            {
                                ...
                                else if (Column_Name == "Rap Rate" || Column_Name == "Rap Value")
                                {
                                    ...
                                    worksheet.Cells[inwrkrow, pkk].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                    worksheet.Cells[inwrkrow, pkk].Style.Fill.BackgroundColor.SetColor(yellow);
                                    worksheet.Column(pkk).Hidden = true;
                                }
                                else if (Column_Name == "Final Disc")
                                {
        ...
        public static void Create_Purchase_Detail_With_Pending_Repricing_Excel(DataTable dt, DataTable column_dt, string _strFolderPath, string _strFilePath)
        {
            try
            {
                using (ExcelPackage ep = new ExcelPackage())
