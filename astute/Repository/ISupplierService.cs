...
namespace astute.Repository
{
    public partial interface ISupplierService
    {
        ...
        Task<(List<Dictionary<string, object>>, string, string, string, string)> Get_Stock_Avalibility_Report_Search(DataTable dataTable, string stock_Id, int iPgNo, int iPgSize, IList<Report_Sorting> iSort);
        ...
        Task<DataTable> Get_Excel_Report_Search(IList<Report_Filter_Parameter> report_Filter_Parameters, string excel_Format, string supplier_Ref_No);
        #endregion
    }
}
