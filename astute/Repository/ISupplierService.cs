...
namespace astute.Repository
{
    public partial interface ISupplierService
    {
        ...
        Task<(List<Dictionary<string, object>>,string, string, string, string)> Get_Report_Search(int id, IList<Report_Filter_Parameter> report_Filter_Parameters, int iPgNo, int iPgSize);
