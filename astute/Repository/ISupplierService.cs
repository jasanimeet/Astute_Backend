...
namespace astute.Repository
{
    public partial interface ISupplierService
    {
        ...
        Task<int> Supplier_Stock_Overseas_Insert_Update(int supplier_Id, int stock_Data_Id);
        Task<int> Supplier_Stock_Manual_File_Insert_Update(int supplier_Id, int stock_Data_Id, bool is_Overwrite);
        Task<int> Supplier_Stock_Overseas_Manual_File_Insert_Update(int supplier_Id, int stock_Data_Id, bool is_Overwrite);
