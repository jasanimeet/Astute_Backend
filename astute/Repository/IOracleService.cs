...
namespace astute.Repository
{
    public partial interface IOracleService
    {
        ...
        Task<int> Order_Data_Transfer_Oracle(IList<Order_Processing_Complete_Detail> order_Processing_Complete_Details, Employee_Fortune_Master employee_Fortune_Master, string Summary_QC_Remarks);
