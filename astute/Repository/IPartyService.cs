...
namespace astute.Repository
{
    public partial interface IPartyService
    {
        ...
        Task<IList<Dictionary<string, object>>> GetPartyFromCache(int partyId, string partyType);
        ...
        Task<IList<Dictionary<string, object>>> Get_Demo_Party(int party_Id, string party_Type);
        //Task<List<Dictionary<string, object>>> GetParty(int party_Id, string party_Type);
