...
namespace astute.Repository
{
    public partial class PartyService : IPartyService
    {
        ...
        public async Task<IList<Party_Master_Replica>> GetParty_Raplicate(int party_Id, string party_Type, int company_Code)
        {
            ...
            return await _dbContext.Party_Master_Replica.FromSqlRaw("exec Party_Master_Select_Raplicate @PartyId, @Party_Type, @Company_Code", partyId, partyType, _company_Code).AsNoTracking()
                .ToListAsync();
