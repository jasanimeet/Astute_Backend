...
namespace astute.Repository
{
    public partial class SupplierService : ISupplierService
    {
        ...
        public async Task<Dictionary<string, object>> Get_Purchase_Barcode_Print(int Trans_Id)
        {
            var output = new Dictionary<string, object>();
        ...
        public async Task<List<Dictionary<string, object>>> Purchase_Detail_QC_Pending()
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_QC_Pending", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<Dictionary<string, object>>> Get_Transaction_For_Merge(int Trans_Id)
        {
            ...
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("[dbo].[Transaction_For_Merge]", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<DataTable> Get_Sales_Transaction_Excel(int Trans_Id)
        {
            var dataTable = new DataTable();

            var connectionString = _configuration["ConnectionStrings:AstuteConnection"];
            using (var connection = new SqlConnection(connectionString))
            using (var command = new SqlCommand("Transaction_Sales_Detail_By_Trans_Id_Select_Excel", connection))
            {
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.AddWithValue("@Trans_Id", Trans_Id > 0 ? (object)Trans_Id : DBNull.Value);
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Detail_For_Release(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_For_Release_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<Dictionary<string, object>>> Get_Unavailable_Purchase_Detail_For_Release(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_Unavailable_For_Release_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Transaction_Hold_Customer_DropDown(int User_Id)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Detail_For_Consignment_Issue(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            ...
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_For_Consignment_Issue_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Assist_Person_Id > 0 ? new SqlParameter("@Assist_Person_Id", purchase_Detail_For_Purchase_Return.Assist_Person_Id) : new SqlParameter("@Assist_Person_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Unavailable_Purchase_Detail_For_Consignment_Issue(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_Unavailable_For_Consignment_Issue_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Detail_For_Consignment_Receive(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_For_Consignment_Receive_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Unavailable_Purchase_Detail_For_Consignment_Receive(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_Unavailable_For_Consignment_Receive_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Detail_For_Internal_Issue(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_For_Internal_Issue_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Assist_Person_Id > 0 ? new SqlParameter("@Assist_Person_Id", purchase_Detail_For_Purchase_Return.Assist_Person_Id) : new SqlParameter("@Assist_Person_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Unavailable_Purchase_Detail_For_Internal_Issue(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_Unavailable_For_Internal_Issue_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Detail_For_Internal_Receive(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_For_Internal_Receive_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Unavailable_Purchase_Detail_For_Internal_Receive(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_Unavailable_For_Internal_Receive_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Transaction_Internal_Issue_Customer_DropDown(int User_Id)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Transaction_Internal_Issue_Customer_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(User_Id > 0 ? new SqlParameter("@User_Id", User_Id) : new SqlParameter("@User_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Detail_For_Sales(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_For_Sales_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Unavailable_Purchase_Detail_For_Sales(Purchase_Detail_For_Purchase_Return purchase_Detail_For_Purchase_Return)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Purchase_Detail_Unavailable_For_Sales_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(!string.IsNullOrEmpty(purchase_Detail_For_Purchase_Return.Certificate_No) ? new SqlParameter("@Certificate_No", purchase_Detail_For_Purchase_Return.Certificate_No) : new SqlParameter("@Certificate_No", DBNull.Value));
                    command.Parameters.Add(purchase_Detail_For_Purchase_Return.Customer_Id > 0 ? new SqlParameter("@Customer_Id", purchase_Detail_For_Purchase_Return.Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Transaction_Sales_Customer_DropDown(int? User_Id)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Transaction_Sales_Customer_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(User_Id > 0 ? new SqlParameter("@User_Id", User_Id) : new SqlParameter("@User_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Transaction_Sales_Invoice_DropDown(int Customer_Id)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("Transaction_Sales_Invoice_Select", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.Add(Customer_Id > 0 ? new SqlParameter("@Customer_Id", Customer_Id) : new SqlParameter("@Customer_Id", DBNull.Value));
        ...
        public async Task<List<Dictionary<string, object>>> Get_Purchase_Master_With_Pending_Upcoming_QC_Pricing(int? Trans_Id, string? CertOrStockId)
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
        ...
        public async Task<Dictionary<string, object>> Lab_Entry_Detail_Auto_Generate_Sunrise_Stock_Id()
        {
            var result = new List<Dictionary<string, object>>();
            using (var connection = new SqlConnection(_configuration["ConnectionStrings:AstuteConnection"].ToString()))
            {
                using (var command = new SqlCommand("[dbo].[Lab_Entry_Detail_Auto_Generate_Sunrise_Stock_Id]", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
